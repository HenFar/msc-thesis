...
\chapter*{Abstract}
High-precision collider measurements need theoretical predictions that are accurate 
to the same level. In perturbative Quantum Chromodynamics (QCD), these predictions 
are organised as an expansion in the strong coupling constant, \(\alpha_s\). At higher 

...
\node[label={[text=gray]right:\textit{Passarino-Veltman}}] at (-2,-2) {};

% circle points
\filldraw[black] (0,-1) circle (2pt) node[anchor=south, yshift = 2pt]{$A_2^1$};
\filldraw[black] (2.5,-1) circle (2pt) node[align=center, anchor=south, yshift = 2pt]{Passarino- \\ -Veltman};
...
\end{tikzpicture}
\caption{Passarino-Veltman reduction for the $A_2^1$ antenna integration.}

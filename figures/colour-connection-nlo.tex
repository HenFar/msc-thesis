...
\end{tikzpicture}
\caption{\centering The colour connections in between parent and daughter partons before and after an emission, accompanied also by the corresponding amplitude-level factorisation, using the momenta labels.}

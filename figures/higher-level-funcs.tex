...
\filldraw[black] (3,-5.5) node[align=center, anchor=center]{\scriptsize Passarino- \\ \scriptsize -Veltman};
...
\begin{pgfonlayer}{background}
  ...
  \fill[black!10, rounded corners] (-2.5,1) rectangle (12.5,-14);
\end{pgfonlayer}
...
\end{tikzpicture}
\caption{\centering Diagram showing the complete \textit{AntCalc} workflow including higher-level functions.}

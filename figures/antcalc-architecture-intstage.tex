...
\draw[black, thick] (11,0) -- (11,-10.4);

% back and frontend backgrounds
\begin{pgfonlayer}{background}
  % Draws a light blue rectangle behind a specific region
  \fill[blue!10, rounded corners] (-2.5,1) rectangle (13.5,-8);
    
  % Or a light gray box behind another region
  \fill[black!5, rounded corners] (-2.5,-8) rectangle (13.5,-12);
...
\node[label={[text=blue!60]above:\textit{Backend}}] at (12.5,-8) {};
\node[label={[text=gray]below:\textit{Frontend}}] at (12.5,-8) {};
...
% output nodes
\node[draw, fill=black, isosceles triangle, isosceles triangle apex angle=60, inner sep=2pt, shape border rotate=-90, label={[align=center, anchor=west, label distance=3pt]below:Default \\ Integrate \\ Output}] at (11,-10.4) {};
...
\node[align=center, anchor=west] at (3.05,-7.05) {Public \\ Integration Views \\ \footnotesize(incl.\ UV renorm.):};
\draw[black!80, thick] (3.8, -7.95) -- (3.8, -8.85);
\node[anchor=west] at (3.9,-8.2) {\texttt{ReturnTTerms}};
\node[anchor=west] at (3.9,-8.6) {\texttt{ReturnMasterCombination}};

\node[align=center, anchor=west] at (3.05,-9.45) {Diagnostics};
\draw[black!80, thick] (3.8, -9.95) -- (3.8, -10.4);
\node[anchor=west] at (3.9,-10.2) {\texttt{DetailedTimingDiagnostics}};

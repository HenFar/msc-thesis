...
% arrows
\node[draw, fill=black, circle, inner sep=2pt, label={[align=center]above:$\mathcal M_2^{2,[2\times 0]}$}] at (4,0) {};
\node[draw, fill=black, regular polygon, regular polygon sides=5, inner sep=2pt, label={[align=center]below:$\mathcal M_2^{2,[1\times 1]}$}] at (4,-2) {};

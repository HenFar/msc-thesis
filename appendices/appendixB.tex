...
function used for $A_3^0$'s collinear limit in Section~\ref{subsubsec:a30CollinearLimit}, needed
since $A_4^0$ is an NNLO antenna and the $\epsilon$-dependent term no longer drops out of the check \cite{Gehrmann-DeRidder:2005btv}.
...
% TODO: intro sentence(s) — mass-corrected analogue of the massless A_3^0 check,
% cf. \cite{GehrmannDeRidder:2009fz}.

\subsubsection{Soft Limit and the Eikonal Factor}

% TODO: limit setup + \textit{AntCalc} Mathematica computation, mdframed block below.

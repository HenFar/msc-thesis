...
\subsection{Two-Parton Contributions: the $A_2^2$ Set}\label{subsec:A22}
    ...
    \begin{equation*}
        \begin{split}
            \Bigg\{&\frac{11\Big[(3+2\epsilon)B_0\!\left(s_{12};0,0\right)+2s_{12}C_0\!\left(0,0,s_{12};0,0,0\right)\Big]}{12\epsilon}+...,\\
              ...
              &\frac{\Gamma^2(1+\epsilon)\Gamma^6(1-\epsilon)}{4\epsilon^4\Gamma^2(2-2\epsilon)}+...\Bigg\}
        \end{split}
    \end{equation*}
\end{mdframed}
    ...
    \begin{equation*}
        \begin{split}
            \Bigg\{&\frac1{4\epsilon^4}+\frac{17}{8\epsilon^3}+\frac{433-72\pi^2}{144\epsilon^2}+\frac{121350-44820\pi^2+15120\zeta_3}{25920\epsilon}\\
                   ...
                   &+18-\frac{41\pi^2}{96}-\frac{7\pi^4}{480}-\frac{7\zeta_3}{2}\Bigg\}
        \end{split}
    \end{equation*}
\end{mdframed}
...
\texttt{Out[3]:=}
    \begin{equation*}
        \begin{split}
            \Bigg\{&\frac3{4\epsilon^4}+\frac{65}{24\epsilon^3}+\frac{1}{\epsilon^2}\!\left(\frac{217}{18}-\frac{13\pi^2}{12}\right)+\frac1\epsilon\!\left(\frac{43223}{864}-\frac{589\pi^2}{144}-\frac{71\zeta_3}{4}\right)\\

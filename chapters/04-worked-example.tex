\chapter{Worked Example: $A_3^0$ End To End}\label{ch:workedexample}
...
\section{Mathematical Derivation}\label{sec:matDerivation}

\subsection{Physics Definition}
...
\subsection{Computing the Amplitude}
...
\subsection{Squared Matrix Element}
...
\subsection{Antenna Building and Normalisation}
...
\subsection{Antenna Integration}\label{sec:antIntMaths}
...
\section{Computational Derivation}

\subsection{Antenna Building}

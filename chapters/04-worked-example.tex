...
are discussed in Appendix~\ref{sec:MIA22}:
...
Appendix~\ref{sec:MIA31}. The ultraviolet counterterm $-\frac{11}{6\epsilon}\mathcal A_3^0$
is added to this combination only after the reduction, and is built from the integrated
tree-level antenna of Subsection~\ref{sec:matDerivation}; it therefore involves the master

...
from the QCD Lagrangian, as shown in Eq.~\ref{eq:qcdLagrangian},
...
the Ward-Takahashi~\cite{Ward:1950xp, Takahashi:1957xn} and Slavnov-Taylor Identities
\cite{Taylor:1971ff, Slavnov:1972fg},
...
Further details of these effective-theory constructions are given in the cited 
literature.
...
\footnote{This process is derived completely in Appendix~\ref{ap:supportingDerivations}.}, 
we can describe the 
...
phase space property\footnote{This property is discussed further in Subsection 
\ref{subsec:phaseSpaceFactor}.} \cite{Catani:1996vz}, 

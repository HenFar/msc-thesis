...
\begin{equation}
    \begin{gathered}
        ...
        \end{aligned}\\
        = NA_4^0(1_q,3_g,4_g,2_{\bar q})-\frac1N\tilde A_4^0(1_q,3_g,4_g,2_{\bar q})
    \end{gathered}
\end{equation}
...
\begin{equation}
    M_{qg\bar q}^1 = N\!\left(A_{3,\text{ren}}^1+\frac{11}{6\epsilon}A_3^0\right)-\frac1N\tilde A_{3,\text{ren}}^1+N_f\!\left(\hat A_{3,\text{ren}}^1-\frac{1}{3\epsilon}A_3^0\right).
\end{equation}
...
\begin{equation}
    M_{qg\bar q}^1 = N\!\left(A_{3}^1+A_3^0\left(\frac{11}{6\epsilon}+A_2^1\right)\right)-\frac1N\left(\tilde A_{3}^1+A_2^1A_3^0\right)+N_f\!\left(\hat A_{3}^1-\frac{1}{3\epsilon}A_3^0\right)
\end{equation}
...
\begin{equation}\label{eq:a22Amp}
    \begin{gathered}
        M_{q\bar q}^2 = \frac{2\operatorname{Re}\!\left(\mathcal M_2^{0\,\dagger}(1_q,2_{\bar q})\mathcal M_2^2(1_q,2_{\bar q})\right)+\mathcal M_2^{1\,\dagger}(1_q,2_{\bar q})\mathcal M_2^1(1_q,2_{\bar q})}{|\mathcal M_2^0(1_q,2_{\bar q})|^2} = \frac{|\mathcal M_2^{2,[2\times 0]}|^2+|\mathcal M_2^{2,[1\times 1]}|^2}{|\mathcal M_2^0|^2}\\
        = NA_{2,\text{bare}}^2 + \frac1N \tilde A_{2,\text{bare}}^2 + N_f \hat A_{2,\text{bare}}^2 + \left(N-\frac1N\right)\breve A_{2,\text{bare}}^2\\

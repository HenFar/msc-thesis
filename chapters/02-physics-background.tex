...
This third method is the one used throughout the present work, since \textit{AntCalc}'s 
...
and $d\sigma^T$ coincide identically with $d\sigma^R$, $d\sigma^{RR}$, and $d\sigma^{RV}$

...
\begin{equation}
    \begin{gathered}
        ...
        d\sigma^{RV}_\text{NNLO} = d\Phi_{m+1}(q:p_1,...,p_{m+1})\frac1{S_{m+1}}\,2\operatorname{Re}\!\left(\mathcal M_{m+1}^1(p_1,...,p_{m+1})\mathcal M_{m+1}^{0\,*}(p_1,...,p_{m+1})\right)J_m^{(m+1)}(p_1,...,p_{m+1}),\\
        \begin{aligned}

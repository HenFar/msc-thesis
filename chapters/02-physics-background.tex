...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[baseline=0pt]
        ...
        \node at ($(b1)+(2.9,-0.2)$) {\Large\(=\)};

        % Panel 2: reduced Born process
        \begin{feynman}
            \vertex [right=4.6cm of g1] (g2) {\(\gamma^*\)};
...
which guarantee the conservation of the electric and colour charges,
...
\begin{table}[h]
    ...
    \cite{Gehrmann-DeRidder:2005btv}. The tilde denotes the subleading-colour contribution,

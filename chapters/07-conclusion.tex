...
This thesis developed the \textit{Mathematica} package \textit{AntCalc} to remove a friction
that recurs at the start of most new antenna-subtraction calculations: before the intended
physics can even be pursued, a group must first reconstruct and integrate the antenna functions
it needs from scratch, much as Feynman-diagram algebra once had to be carried out by hand before
tools such as \textit{FeynCalc} became standard. \textit{AntCalc} removes this initial barrier,
providing a validated, ready-to-use library of antenna functions that can be loaded directly into
a \textit{Mathematica} notebook, making their construction and everyday use easier, more

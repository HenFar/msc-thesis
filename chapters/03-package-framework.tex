...
substituted, so that the public build result is expressed in terms of the invariant $s_{12}$ and
$\epsilon$ alone. Passarino-Veltman reduction enters this route only through the unintegrated

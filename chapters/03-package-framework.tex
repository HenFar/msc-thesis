...
Much like for all other loop routes, Passarino-Veltman reduction is used on the build side to
remove the two loop momenta $\ell_1$ and $\ell_2$, while IBP reduction is subsequently used to
obtain the full result in terms of its $\epsilon$-poles.
It is remarkably different from the rest, however. The four-component set is not generated like

...
now consider the two NLO $\mathcal T$-objects, $\mathcal T_{q\bar q}^4$ and $\mathcal T_{q\bar qg}^6$, 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/rratio-full-domain.pdf}
    \caption{}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/rratio-continuum-orders.pdf}
    \caption{}

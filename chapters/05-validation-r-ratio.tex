...
\end{equation}
\begin{equation}
    T_{q\bar qq\bar q}^6 = P\left(B_4^0-\frac2N C_4^0\right),
\end{equation}
\begin{equation}
    T_{q\bar qgg}^6 = P\left(NA_4^0-\frac1{2N}\tilde A_4^0\right).
\end{equation}
...
considered in this work, the calculation is performed with,
